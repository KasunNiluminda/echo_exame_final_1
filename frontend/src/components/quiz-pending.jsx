...
function quizPending() {
  return (
    <>
      <div>
        <div className="flex py-14 px-20 justify-center">
          <div>
            <h4 className="capitalize text-primary">Quiz Pending</h4>
          </div>
        </div>
        ...
        <div className="container mx-auto my-10">
          ...
          <Link to="#" className="flex hover:shadow-2xl justify-between px-5 mt-10 border-2 border-primary p-7">
            <div>
            ...
            <div className="self-center">
              <div>
              <button  className="text-4xl text-[#ff0000]">
